...
@implementation HBSendDoorOpenInfo : NSObject
@end

@implementation HBDoorListInfo : NSObject
@end

@implementation HBAttendRequesInfo : NSObject
@end

@implementation HBAttendRecord : NSObject
@end

@implementation HBAttendStatisticInfo : NSObject
@end

@implementation HBUserMessage : NSObject
@end

@implementation HBMessageInfo : NSObject
@end

@implementation HBReply : NSObject
@end

@implementation HBMsgRequestInfo : NSObject
@end

@implementation HBReplyContent : NSObject
@end

@implementation HBUserJournal : NSObject
@end

@implementation HBJournalInfo : NSObject
@end

@implementation HBJournalRequestInfo : NSObject
@end

@implementation HBPosition : NSObject
@end

@implementation HBContactRequest : NSObject
@end

@implementation HBContact : NSObject
@end

@implementation HBContactDept : NSObject
@end

@implementation HBContactInfo : NSObject
@end

@implementation HBUpdateInfo : NSObject
@end

@implementation HBBugInfo : NSObject
@end

@implementation HBRegistRequest : NSObject
@end

@implementation HBRegistReply : NSObject
@end

@implementation HBCustomConfig : NSObject
@end

@implementation HBMeetingInfo : NSObject
@end

@implementation HBUserMeeting : NSObject
@end

@implementation HBMeetRequestInfo : NSObject
@end
